        ...
        <div class="main-page">
          ...
          <div class="container-fluid">
            <div class="row page-title-div">
              <div class="col-md-12">
                <h2 class="title" class="text-align: center">KẾT QUẢ TRA CỨU</h2>
              </div>
            </div>
          </div>
                  ...
                  <div class="panel">
                    <div class="panel-heading">
                      <div class="panel-title">
                        <h3 class="text-align: center">Chi Tiết Điểm Học Phần</h3>
                        <hr />
<?php
  $msv=$_POST["ma_sv"];
  $mhp=$_POST["ma_hoc_phan"];
  
  $_SESSION["ma_sv"]=$msv;
  $_SESSION["ma_hoc_phan"]=$mhp;

  $sql = "SELECT sv.ma_sv, sv.ho_lot, sv.ten, hp.ma_hoc_phan, hp.ten_hoc_phan, dhp.A, dhp.B, dhp.C FROM tbl_sinhvien AS sv INNER JOIN tbl_hocphan AS hp INNER JOIN tbl_diemhocphan AS dhp WHERE sv.ma_sv=:ma_sv AND hp.ma_hoc_phan =:ma_hoc_phan AND sv.ma_sv=dhp.ma_sv AND hp.ma_hoc_phan=dhp.ma_hoc_phan";

  $cmd = $dbh->prepare($sql);
  $cmd->bindParam(':ma_sv',$msv);
  $cmd->bindParam(':ma_hoc_phan',$mhp);
  $cmd->execute();
...
?>
                  ...
                  <div class="form-group">                                                           
                    <div class="col-sm-6">
                      <a href="find-result.php"> << Quay lại </a>
                    </div>
                  </div>
                </div>                
              </div>
